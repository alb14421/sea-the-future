...
//>>built
define(["exports","../views/3d/environment/ChapmanRaymarching.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/Gamma.glsl","../views/3d/webgl-engine/core/shaderLibrary/shading/MainLighting.glsl","../views/3d/webgl-engine/core/shaderModules/Float3PassUniform","../views/3d/webgl-engine/core/shaderModules/FloatPassUniform","../views/3d/webgl-engine/core/shaderModules/glsl","../views/3d/webgl-engine/core/shaderModules/Texture2DBindUniform","../views/3d/webgl-engine/shaders/ScreenSpacePassAtmosphere.glsl","../views/3d/webgl-engine/shaders/SphereIntersect.glsl","../views/3d/webgl-engine/shaders/ToneMapping.glsl","../views/webgl/ShaderBuilder"],function(e,a,r,t,i,n,l,o,s,c,d,g){"use strict";function m(e){const m=new g.ShaderBuilder;m.include(s.ScreenSpacePassAtmosphere);const{reduced:h}=e,{fragment:u}=m;return t.addMainLightDirection(u),u.include(r.Gamma),u.include(c.SphereIntersect),u.include(d.ToneMapping),u.include(a.ChapmanRaymarching,!1),u.uniforms.add(new i.Float3PassUniform("backgroundColor",e=>e.backgroundColor),new n.FloatPassUniform("innerFadeDistance",e=>e.innerFadeDistance),new n.FloatPassUniform("altitudeFade",e=>e.altitudeFade),new o.Texture2DBindUniform("depthTexture",e=>e.mainDepth)).code.add(l.glsl`vec4 applyUndergroundAtmosphere(vec3 rayDir, vec3 lightDirection, vec4 fragColor) {
...
return normalize(sunTransmittance) * sunDisc;
      ...
      ${l.If(!h,l.glsl`float depthSample = texture(depthTexture, uv).r;
             if (depthSample != 1.0) {
                fragColor = vec4(0);
                return;
             }`)}
  ...
  `),m}const h=Object.freeze(Object.defineProperty({__proto__:null,build:m},Symbol.toStringTag,{value:"Module"}));e.ChapmanAtmosphere=h,e.build=m});