...
//>>built
define(["exports","../../shaderModules/glsl"],function(e,t){"use strict";e.NormalUtils=function(e,r){r.spherical?e.vertex.code.add(t.glsl`vec3 getLocalUp(in vec3 pos, in vec3 origin) {
